...
def test_checking_password_matching():
    '''
        Description: 
                This function is testing the password having 8 charecters are not
        Parameters: 
                None
        Return : 
                None
    '''
    assert checking_password("121A21212")==True
    assert checking_password("12Weqw12er")==True
    assert checking_password("abDdeasas1")==True
    assert checking_password("12qw12")==False
