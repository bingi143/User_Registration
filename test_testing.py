...
def test_checking_email():
    ...
    #in valid
    assert email_verification("abc")==False
    assert email_verification("abc@.com.my")==False
    assert email_verification("abc123@gmail.a")==False
    assert email_verification("abc123@.com")==False
    assert email_verification("abc123@.com.com")==False
    assert email_verification(".abc@abc.com")==False
    assert email_verification("abc()*@gmail.com")==False
    assert email_verification("abc@%*.com")==False
    assert email_verification("abc..2002@gmail.com")==False
    assert email_verification("abc.@gmail.com")==False
    assert email_verification("abc@abc@gmail.com")==False
    assert email_verification("abc@gmail.com.1a")==False
    assert email_verification("abc@gmail.com.aa.au")==False
   
    #valid
    assert email_verification("abc@yahoo.com")==True
    assert email_verification("abc-100@yahoo.com")==True
    assert email_verification("abc.100@yahoo.com")==True
    assert email_verification("abc111@abc.com")==True
    assert email_verification("abc111@abc.net")==True
    assert email_verification("abc.100@abc.com.au")==True
    assert email_verification("abc@1.com")==True
    assert email_verification("abc@gmail.com.com")==True
    assert email_verification("abc+100@gmail.com")==True
